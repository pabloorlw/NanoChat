...
public class NCCommands {
	...
	public static final byte COM_RENAME = 102;
	public static final byte COM_CREATEROOM = 103;
	public static final byte COM_SENDPRIVATE = 104;
	...
	private static final String[] _valid_user_commands_help = {
		...
		"to set the name of the curren room to <name>",
		"creates the next room in the server",
		"sends a private message to the user <user>"};
